...
- Flashcard content you create (text, images, audio recordings)
- Study session data (cards reviewed, scores, spaced repetition progress)
- A unique user ID to link your data to your account

We do not collect your location, contacts, or browsing history.

## 3. How We Use Your Data
We use your data solely to provide the app's features:
- Syncing your flashcards across your devices
- Calculating your daily study plan via spaced repetition
- Enabling multiplayer study sessions
- Allowing you to share decks publicly (only if you choose to)
